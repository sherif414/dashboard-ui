<template>
  <div
    ...
    class="w-42px h-24px rounded-full relative select-none transition duration-300 cursor-pointer inline-block"
    :class="{ 'fill-primary-3': modelValue, 'bg-gray-2 dark:bg-dark-1': !modelValue }"
  >
    <input v-show="false" type="checkbox" :checked="modelValue" />
    <span
      :class="{
