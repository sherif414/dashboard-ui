  ...
  >
    <div class="flex justify-between">
      ...
      <button type="button" @click="showFilter = !showFilter" v-if="filter" class="relative">
        ...
        >
          <li @click="filterBy = 'day'" class="hover:(fill-primary-2 typo-clr-on-primary) px-2 py-1 cursor-pointer">this day</li>
          <li @click="filterBy = 'week'" class="hover:(fill-primary-2 typo-clr-on-primary) px-2 py-1 cursor-pointer">this week</li>
          <li @click="filterBy = 'month'" class="hover:(fill-primary-2 typo-clr-on-primary) px-2 py-1 cursor-pointer">this month</li>
        </ul>
      </button>
    </div>
